...
<CardGroup>
  <Card title="Add More Workers" icon="user-plus" href="/examples/basic-usage">
    Create more specialized worker agents
  </Card>
  <Card title="Custom Providers" icon="settings" href="/contributing/extending-providers">
    Add support for new LLM providers
  </Card>
  <Card title="API Reference" icon="code" href="/api/officeLLM">
...
- Make sure you're using a supported provider type: `'openai' | 'anthropic' | 'gemini' | 'openrouter'`
- Check that your API key is properly set

**"Task execution failed"**
- Verify your API keys are valid and have sufficient credits
- Check that the provider model you specified is available
- Ensure your system prompts are well-formed

**TypeScript errors**
- Make sure you're using TypeScript 4.5+
- Import types correctly: `import { OfficeLLM } from 'officellm'`
...
process.env.DEBUG = 'officellm:*';

// Or enable in your code
import { OfficeLLM } from 'officellm';
OfficeLLM.setDebug(true);
```
